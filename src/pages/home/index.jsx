...
const HomePage = () => { 
    return ( <React.Fragment>
        <div className={'home'}>
        <div className={"prev-home"}><img src={"./image/main_cosmo.png"} style={{width:100+"%"}} alt="Банер"/>
            <div><h1 style={{top:162, left:92}}>Звёздные миры</h1>
        ...
        <div className={"prev-home"}><img src={"./image/main_cosmo.png"} style={{width:100+"%"}} alt="Банер"/>
            <div><h1 style={{top:65, left:43}}>Звёздные миры</h1>
                <h3>Барнаульский Планетарий – это особый астрономический центр, сочетающий в себе достоинства театра и учебной аудитории. Актёрами в этом необычном театре выступают Солнце, звёзды, планеты, галактики, кометы...</h3>
                <button>Узнать больше</button>
            </div>
        </div>
        ...
        <div className={"write_us"}> <img src={"./image/write-to-us_mobile.jpg"} className={"bacground"} alt="Банер -Напишите нам-"/>
        <div >
            <h1>Напишите нам!</h1>
            <div class="text-field">
